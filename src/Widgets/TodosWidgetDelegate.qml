...
C.SwipeDelegate {
    ...
    contentItem: RowLayout {
        ...
        C.Symbol {
            ...
            symbol: {
                ...
                case "Todo":
                case "Task":
                    return swipeDelegate.item.done ? C.Icons.mdiTaskAlt : C.Icons.mdiCircle
                case "TodoList":
                    return C.Icons.mdiChecklist
                case "Note":
                    return C.Icons.mdiDescription
                case "Image":
                    return C.Icons.mdiImage
                default:
        ...
        Column {
            ...
            C.Label {
                text: Markdown.markdownToHtml(swipeDelegate.item.title, palette)
            ...
            Flow {
                ...
                Row {
                    ...
                    C.Label {
                        font.family: C.Fonts.iconFont
                        text: C.Icons.mdiChecklist
                        width: contentWidth
                        height: contentHeight
                        color: Colors.itemColor(d.parentItem,
        ...
        C.Label {
            font.family: C.Fonts.iconFont
            text: C.Icons.mdiNoteAlt
            opacity: (swipeDelegate.item.itemType === "Todo"
                      && swipeDelegate.item.notes !== "") ? 0.5 : 0
        }
    ...
    background: Rectangle {
        color: swipeDelegate.palette.window
    }
